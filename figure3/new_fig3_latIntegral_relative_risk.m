...
id3 = [7 9 10 11 12 21 22 23 24 37 38 39 44 45];
...
for ki = 1 : 1
    ...
    for rri = 1 : rlen
        ...
        load(['D:\Study\fires\Extreme_fires_relationship\MODISv61_newanalysis\2021.10.14.time_series2\region_',num2str(ri),'_all_fire_xth2.mat'],'xdata','yf');
    ...
    fnstd = nanstd(nansum(fnmata,2)./nansum(hdmat,2),0,3);
    szstd = nanstd(nansum(szmata,2)./nansum(hdmat,2),0,3);
...
%     szstd = nanstd(szmat./hdmat,0,2);
    ...
    load D:\Study\fires\Extreme_fires_relationship\MODISv61_newanalysis\2021.10.16.heatwv_nheatwv_comp3\amplification_factor_htwv.mat
...
for ki = 1 : 4
    ...
    for rri = 1 : rlen
        ...
        load(['D:\Study\fires\Extreme_fires_relationship\MODISv61_newanalysis\2021.12.01.duration_ehfy_errorbar\region_',num2str(ri),'_xth_ehf.mat'],'xdata','yt');
        load(['D:\Study\fires\Extreme_fires_relationship\MODISv61_newanalysis\2021.10.14.time_series2\big_fire\region_',num2str(ri),'_forest_fire_xth2.mat'],'xdata','yf');
...
%     szstd = nanstd(szmat./hdmat,0,2);
    ...
    ydata = fnmean;
    ydata2 = ydata / mean(dataall(4,1,2,idd));
    % ydata3 = prctile(fnmat./hdmat,90,2);
    xxf = [xdata fliplr(xdata)];
    xl = length(xdata);
    xxf(1) = 0;xxf(xl) = xl+1; xxf(xl+1) = xl+1; xxf(end) = 0;
    ...
    ee1.Color = [0.40 0.40 0.40];
    hold on,
    yyf = [zeros(1,xl) repmat(mean(dataall(4,1,2,idd)),1,xl)];
    hold on,
    p1 = plot(xdata,ydata,'k-');
    hold on,
    s1 = scatter(xdata,ydata,40,ydata2,'filled');
...
%         text(5,40,'Non-heatwave level','Color',[130 130 130]./255)
    ...
    subplot(1,3,2),
    ydata = szmean./fnmean;
    ydata2 = ydata / mean(dataall(6,1,2,idd));
    ydata(end-2:end) = nan;
    yyf = [zeros(1,xl) repmat(mean(dataall(6,1,2,idd)),1,xl)];
%     f11 = fill(xxf,yyf,[130 130 130]./255);
%     f11.FaceAlpha = 0.2;
%     f11.EdgeColor = 'none';
    hold on,
    ...
    subplot(1,3,3),
    ydata = szmean;
    ydata2 = ydata / mean(dataall(5,1,2,idd));
    negstd = ydata-szstd;
    negstd2 = szstd;
    negstd2(negstd<0) = ydata(negstd<0);
    ydata(end-2:end) = nan;
    ...
    ee2.Color = [0.40 0.40 0.40];
    hold on,
    yyf = [zeros(1,xl) repmat(mean(dataall(5,1,2,idd)),1,xl)];
    hold on,
    p1 = plot(xdata,ydata,'k-');
    hold on,
    line([0 13], [mean(dataall(5,1,2,idd)) mean(dataall(5,1,2,idd))])    
    hold on,
    s1 = scatter(xdata,ydata,40,ydata2,'filled');
    s1.MarkerEdgeColor = 'k';
    colormap(flipud(hot))
...
id1 = [1 2 17 18 28 29 30 31];
% id1 = [1 2 18 28 29 30 31]; % excluding 17, WCE, grass fire in Ukraine
...
for ki = 1 : 4
    ...
    for rri = 1 : rlen
        ...
        load(['D:\Study\fires\Extreme_fires_relationship\2022.02.15.newregion_recomp2\2021.10.14.time_series2\bigfire\region_',num2str(ri),'_nforest_fire_xth2.mat'],'xdata','yf');
...
%     szmean = nanmean(szmat./hdmat,2);
    ...
    load D:\Study\fires\Extreme_fires_relationship\2022.02.15.newregion_recomp2\2021.10.16.heatwv_nheatwv_comp2\bigfire\amplification_factor_htwv.mat
    ...
    ydata = fnmean;
    ydata2 = ydata / mean(dataall(4,1,3,idd));
    % ydata3 = prctile(fnmat./hdmat,90,2);
    xxf = [xdata fliplr(xdata)];
    xl = length(xdata);
    xxf(1) = 0;xxf(xl) = xl+1; xxf(xl+1) = xl+1; xxf(end) = 0;
    ...
    subplot(1,3,1),
    yyf = [zeros(1,xl) repmat(mean(dataall(4,1,3,idd)),1,xl)];
%     f11 = fill(xxf,yyf,[130 130 130]./255);
%     f11.FaceAlpha = 0.2;
%     f11.EdgeColor = 'none';
    hold on,
...
%         text(5,40,'Non-heatwave level','Color',[130 130 130]./255)
    ...
    subplot(1,3,2),
    ydata = szmean./fnmean;
    ydata2 = ydata / nanmean(dataall(6,1,3,idd));
    yyf = [zeros(1,xl) repmat(mean(dataall(6,1,3,idd)),1,xl)];
%     f11 = fill(xxf,yyf,[130 130 130]./255);
%     f11.FaceAlpha = 0.2;
%     f11.EdgeColor = 'none';
    hold on,
    ...
    subplot(1,3,3),
    ydata = szmean;
    ydata2 = ydata / mean(dataall(5,1,3,idd));
    yyf = [zeros(1,xl) repmat(mean(dataall(5,1,3,idd)),1,xl)];
%     f11 = fill(xxf,yyf,[130 130 130]./255);
%     f11.FaceAlpha = 0.2;
%     f11.EdgeColor = 'none';
    hold on,
