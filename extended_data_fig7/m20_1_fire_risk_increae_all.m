...
load D:\Study\fires\Extreme_fires_relationship\2021.11.10.active_fire_modis\comp2\amplification_factor_htwv55_new21.mat
% dataall2 = dataall;
% dataamp22 = dataamp;
% dataamp222 = dataamp2;
% load amplification_factor_htwv.mat
...
%     end
    ...
    if(ci ==1)
        text(14.5,32,'17.9','Color',[0 171 40]/255)
    end
    xlabel(xvalues{i});
    box on
    grid on
...
set(gcf,'position',[428   0   812   670])
