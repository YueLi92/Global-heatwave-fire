%% PM2.5 relationship with fire during heatwaves
...
reg.rsquare
text(8,6,['R^2 (VPD,Lightning,Treecover) = ',num2str(round(reg.rsquare*100)/100)],'FontSize',13,'Color','r')

set(gca,'YLim',[0 7],'XLim',[0 150],'YColor','k','LineWidth',1.2)
xlabel('VPD change during heatwaves (%)')
ylabel('A_H of fire number')
get(gca,'position');
set(gca,'position',[0.1300    0.68    0.3347    0.25]);
set(gca,'FontSize',13)
...
get(gca,'position');
set(gca,'position',[0.5700    0.68    0.3347    0.25]);
set(gca,'FontSize',13)
...
ylabel('A_H of fire number')
get(gca,'position');
set(gca,'position',[0.1300    0.365    0.3347    0.25]);
set(gca,'FontSize',13)
...
ylabel('A_H of burned area')
get(gca,'position');
set(gca,'position',[0.5700    0.365    0.3347    0.25]);
set(gca,'FontSize',13)
...
set(gcf,'position',[480         141        1080        1197])
...
% % zdata = 90-lattvs/4;
% % 
% % s1 = scatter(xdata,ydata,150,zdata,'filled');
% % s1.MarkerEdgeColor = 'none';
% % s1.LineWidth = 2;
% % clcr = jet;
% % % clcr = clcr(1:60,:);
% % % clcr(1:12,:) = repmat([168 230 207]./255,12,1);
% % % clcr(13:24,:) = repmat([220 237 193]./255,12,1);
% % % clcr(25:36,:) = repmat([255 211 182]./255,12,1);
% % % clcr(37:48,:) = repmat([255 170 165]./255,12,1);
% % % clcr(49:60,:) = repmat([255 139 148]./255,12,1);
% % colormap(clcr);
% % caxis([-60 90])
% % c1 = colorbar;
% % c1.Location = 'Northoutside';
...
% % 
% % set(gca,'YLim',[0 6],'XLim',[0 6],'YColor','k')
% % xlabel('Heatwave-Fire')
% % ylabel('Heatwave-PM_{2.5}')
% % get(gca,'position');
% % % set(gca,'position',[0.1500    0.600    0.2134    0.2253]);
...
% % % zdata = 90-lattvs/4;
% % % % North Hemisphere
% % % s1 = scatter(xdata(zdata>0),ydata(zdata>0),150,zdata(zdata>0),'filled');
% % % s1.MarkerEdgeColor = 'none';
% % % s1.LineWidth = 2;
% % % clcr = flipud(hot);
% % % clcr = clcr(1:60,:);
...
% % % c1 = colorbar;
% % % c1.Location = 'Northoutside';
% % % set(c1,'YTick',[-60:15:90],'YTickLabel',{'60^oS','45^oS','30^oS','15^oS','0^o','15^oN','30^oN','45^oN','60^oN','75^oN','90^oN'});
% % % % grid on
% % % box on
% % % % set(gca,'GridLineStyle','-.')
% % % set(gca,'XTick',[0 :1: 6])
...
% % % % ydata = p1./p0;
% % % % zdata = t1-t0;
% % % % % x = [0.05 0.95 0.95 0.05];
% % % % % y = [0.05 0.05 5.95 5.95];
% % % % % pa1 = patch(x,y,[220 220 220]./255,'EdgeColor','none');
% % % % % hold on,
% % % % % x = [0.05 5.95 5.95 0.05];
% % % % % y = [0.05 0.05 0.95 0.95];
% % % % % pa2 = patch(x,y,[220 220 220]./255,'EdgeColor','none');
% % % % % hold on,
% % % % 
% % % % 
% % % % line([0 6],[1 1],'Color','k','LineStyle','--')
...
% % % % for i = 1 : 36
% % % %     if(xdata(i) > 3.5)
% % % %         s1(i) = scatter(xdata(i),ydata(i),50*zdata(i),'filled');
% % % %         s1(i).MarkerEdgeColor = [225 109 118]./255;
% % % %         s1(i).MarkerFaceColor = [255 139 148]./255;
% % % %         s1(i).LineWidth = 1.5;
% % % %         hold on,
% % % %     elseif(xdata(i) < 2)
% % % %         s1(i) = scatter(xdata(i),ydata(i),50*zdata(i),'filled');
% % % %         s1(i).MarkerEdgeColor = [190 207 163]./255;
% % % %         s1(i).MarkerFaceColor = [220 237 193]./255;
% % % %         s1(i).LineWidth = 1.5;
% % % %         hold on,
% % % %     else
% % % %         s1(i) = scatter(xdata(i),ydata(i),50*zdata(i),'filled');
% % % %         s1(i).MarkerEdgeColor = [150 150 150]./255;
% % % %         s1(i).MarkerFaceColor = [200 200 200]./255;
% % % %         s1(i).LineWidth = 1.5;
% % % %         hold on,
% % % %     end
% % % % end
...
% % % % set(gca,'YTick',[0 : 1: 6])
% % % % 
% % % % set(gca,'YLim',[0 6],'XLim',[0 6],'YColor','k','LineWidth',1.2)
% % % % xlabel('Heatwave-Fire')
% % % % ylabel('Heatwave-PM_{2.5}')
% % % % get(gca,'position');
% % % % % set(gca,'position',[0.1500    0.600    0.2134    0.2253]);
...
%% PM2.5 relationship with fire during heatwaves - new
...
xlabel('Predicted A_H of fire number')
ylabel('A_H of fire number')
get(gca,'position');
...
set(gca,'YLim',[0 7],'XLim',[0 7],'YColor','k','LineWidth',1.2)
xlabel('Predicted A_H of burned area')
ylabel('A_H of burned area')
get(gca,'position');
...
%% PM2.5 relationship with fire during heatwaves - new, new
